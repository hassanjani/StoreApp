...
import 'package:user_app/data/repository/brand_repo.dart';
import 'package:user_app/data/repository/cart_repo.dart';
import 'package:user_app/data/repository/category_repo.dart';
import 'package:user_app/data/repository/chat_repo.dart';
import 'package:user_app/data/repository/coupon_repo.dart';
...
import 'package:user_app/data/repository/onboarding_repo.dart';
import 'package:user_app/data/repository/product_details_repo.dart';
import 'package:user_app/data/repository/order_repo.dart';
import 'package:user_app/data/repository/product_repo.dart';
import 'package:user_app/data/repository/profile_repo.dart';
import 'package:user_app/data/repository/search_repo.dart';
import 'package:user_app/data/repository/seller_repo.dart';
import 'package:user_app/data/repository/splash_repo.dart';
import 'package:user_app/data/repository/support_ticket_repo.dart';
import 'package:user_app/data/repository/wishlist_repo.dart';
...
import 'package:user_app/provider/product_details_provider.dart';
